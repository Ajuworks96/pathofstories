      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
          ...
          <div className="w-full lg:col-span-7 space-y-6">
            ...
            {/* Live Status Badge */}
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-[#162E27]/90 border border-[#2F5D50] backdrop-blur-md shadow-xl">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight font-sans text-[#FAF7F1] break-normal">
              Where Every Path <br className="hidden sm:inline" />
              Becomes An <br />
              <span className="font-serif italic font-normal text-transparent bg-clip-text bg-gradient-to-r from-[#E8DCC8] via-[#FAF7F1] to-[#6B8A6E] text-3xl sm:text-5xl lg:text-7xl block mt-1">
                Unforgettable Story.
              </span>
            </h1>

            {/* Official Brand Mission Copy */}
            <p className="text-[#E8DCC8]/90 text-sm sm:text-base lg:text-lg font-light leading-relaxed max-w-xl break-normal">
            ...
            {/* CTA Action (Clean Single Primary Button) */}
            ...
            <div className="pt-4 flex flex-wrap items-center gap-6 sm:gap-8 border-t border-[#2F5D50]/40 text-xs text-[#E8DCC8]/80 w-full">
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  <div className="w-8 h-8 rounded-full bg-[#2F5D50] border-2 border-[#0E1F1A] flex items-center justify-center text-[10px] font-bold text-[#FAF7F1]">AA</div>
                  <div className="w-8 h-8 rounded-full bg-[#6B8A6E] border-2 border-[#0E1F1A] flex items-center justify-center text-[10px] font-bold text-[#FAF7F1]">JK</div>
              ...
              <div className="h-8 w-px bg-[#2F5D50]/40 hidden sm:block" />

              <div className="flex items-center gap-6">
                <div>
                  <span className="text-xl font-extrabold text-[#FAF7F1] font-serif block">110+</span>
                  <span className="text-[10px] text-[#E8DCC8]/60 uppercase font-bold tracking-wider">Expeditions</span>
                </div>
                <div>
                  <span className="text-xl font-extrabold text-[#FAF7F1] font-serif block">13k+</span>
                  <span className="text-[10px] text-[#E8DCC8]/60 uppercase font-bold tracking-wider">Community</span>
                </div>
              </div>
            </div>
